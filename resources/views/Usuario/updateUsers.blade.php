...
@section('content')
    <div class="container-fluid">
        ...
        <div class="container py-3 bg-light border border-2 rounded-2 col-sm-12 col-md-6 col-lg-6 mb-2">
            ...
            <h2 class="col-12 font-italic font-weight-bold fs-5 mt-2 mb-2">Datos Personales</h2>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #3441BB"><i
